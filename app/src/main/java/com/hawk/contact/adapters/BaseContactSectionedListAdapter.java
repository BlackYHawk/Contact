...
import com.hawk.contact.widget.PinnedSectionListView;
 ...
 */
abstract class BaseContactSectionedListAdapter<T> extends BaseAdapter
    ...
    public BaseContactSectionedListAdapter(Activity activity, int viewLayoutId,
